...
if (!isNull (findDisplay 312)) then {
	...
	["Add CAS Drone",[
		...
		[_classname,_callsign,[west,east,independent] # _sideSelection,parseNumber _cooldown,parseNumber _loiterTime] call SSS_fnc_addCASDrone;
