...
private _ropeLength = (getPos _vehicle) # 2 - 0.5;
private _ropes = [];
...
[{
	...
	[{
		...
		[_vehicle,_unit,_ropes] remoteExecCall ["SSS_fnc_transportDoFastrope",_unit];
	},1.5,[_vehicle,_ropes]] call CBA_fnc_addPerFrameHandler;
},[_vehicle,_ropes],2] call CBA_fnc_waitAndExecute;
