...
if (!local _vehicle) exitWith {_this remoteExecCall [QFUNC(addCASHeli),_vehicle];};
...
// Assignment
[true,format ["SSS_CASHelis_%1",_side],_vehicle] remoteExecCall [QEFUNC(common,editServiceArray),2];
