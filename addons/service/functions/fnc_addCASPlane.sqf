...
if (!isServer) exitWith {_this remoteExecCall [QFUNC(addCASPlane),2];};
...
// Assignment
[true,format ["SSS_CASPlanes_%1",_side],_entity] remoteExecCall [QEFUNC(common,editServiceArray),2];
