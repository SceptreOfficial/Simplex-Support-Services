...
if (!isServer) exitWith {
	[QEGVAR(common,execute),[_this,QFUNC(addBoat)]] call CBA_fnc_serverEvent;
	objNull
};
...
_taskTypes = BOAT_TASK_TYPES arrayIntersect (_taskTypes apply {toUpper _x});
