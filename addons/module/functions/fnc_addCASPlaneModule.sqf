...
if (!isNull (findDisplay 312)) then {
	...
	["Add CAS Plane",[
		...
		[_classname,_callsign, parseSimpleArray _weaponSet,[west,east,independent] # _sideSelection,parseNumber _cooldown] call EFUNC(service,addCASPlane);
	...
	] call EFUNC(service,addCASPlane);
};
