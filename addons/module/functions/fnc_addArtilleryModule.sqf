...
if (!isNull (findDisplay 312)) then {
	...
	["Add Artillery",[
		...
		[_object,_callsign,parseNumber _respawnTime,[parseNumber _cooldown,parseNumber _roundCooldown]] call EFUNC(service,addArtillery);
	...
	] call EFUNC(service,addArtillery);
};
