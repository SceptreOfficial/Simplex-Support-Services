...
if (!isServer) exitWith {
	[QEGVAR(common,execute),[_this,QFUNC(addAirdrop)]] call CBA_fnc_serverEvent;
	objNull
};
...
_entity setVariable [QPVAR(openAltitudeAI),_openAltitudeAI,true];
_entity setVariable [QPVAR(openAltitudeObjects),_openAltitudeObjects,true];
