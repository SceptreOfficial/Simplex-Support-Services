class CfgVehicles {
	...
	class SSS_Module_AddArtillery : SSS_Module_Base {
		...
		icon = ICON_ARTILLERY;
		function = QEFUNC(module,addArtilleryModule);
		scope = 2;
		scopeCurator = 2;
		class Arguments {
			class Callsign {
	...
	class SSS_Module_AddCASDrone : SSS_Module_Base {
		...
		icon = ICON_DRONE;
		function = QEFUNC(module,addCASDroneModule);
		scope = 2;
		scopeCurator = 2;
		class Arguments {
			class Classname {
	...
	class SSS_Module_AddCASGunship : SSS_Module_Base {
		...
		icon = ICON_GUNSHIP;
		function = QEFUNC(module,addCASGunshipModule);
		scope = 2;
		scopeCurator = 2;
		class Arguments {
			class Callsign {
	...
	class SSS_Module_AddCASHeli : SSS_Module_Base {
		...
		icon = ICON_HELI;
		function = QEFUNC(module,addCASHeliModule);
		scope = 2;
		scopeCurator = 2;
		class Arguments {
			class Callsign {
	...
	class SSS_Module_AddCASPlane : SSS_Module_Base {
		...
		icon = ICON_PLANE;
		function = QEFUNC(module,addCASPlaneModule);
		scope = 2;
		scopeCurator = 2;
		class Arguments {
			class Classname {
	...
	class SSS_Module_AddTransport : SSS_Module_Base {
		...
		icon = ICON_HELI;
		function = QEFUNC(module,addTransportModule);
		scope = 2;
		scopeCurator = 2;
		class Arguments {
			class Callsign {
	...
	class SSS_Module_RemoveCASDrone : SSS_Module_Base {
		...
		icon = ICON_GEAR;
		function = QEFUNC(module,removeCASDroneModule);
		scopeCurator = 2;
	};
	...
	class SSS_Module_RemoveCASGunship : SSS_Module_Base {
		...
		icon = ICON_GEAR;
		function = QEFUNC(module,removeCASGunshipModule);
		scopeCurator = 2;
	};
	...
	class SSS_Module_RemoveCASPlane : SSS_Module_Base {
		...
		icon = ICON_GEAR;
		function = QEFUNC(module,removeCASPlaneModule);
		scopeCurator = 2;
	};
};
