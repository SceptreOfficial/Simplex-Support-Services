...
[LLSTRING(SelectObject),[
	...
	["LISTNBOX",LLSTRING(AvailableObjects),[_beautifiedList,0,10]],
	["SLIDER",LLSTRING(Amount),[[1,_maxAmount,0],1],true,{},_maxAmount >= 1]
],{
