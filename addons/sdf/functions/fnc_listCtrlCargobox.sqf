...
_ctrlBG1 ctrlSetPosition [0,_posY + ITEM_H + SPACING_H,CARGOBOX_W,_height];
...
_ctrlBG2 ctrlSetPosition [CARGOBOX_W + SPACING_W + CARGOBOX_BUTTON_W + SPACING_W,_posY + ITEM_H + SPACING_H,CARGOBOX_W,_height];
