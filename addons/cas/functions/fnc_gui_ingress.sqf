...
private _hashKey = "ingress";
private _ctrlGroup = ctrlParent _ctrl displayCtrl IDC_INSTRUCTIONS_GROUP;
private _ctrlToolbox = _ctrlGroup controlsGroupCtrl IDC_INGRESS;
private _ctrlSlider = _ctrlGroup controlsGroupCtrl IDC_INGRESS_SLIDER;
private _ctrlSliderEdit = _ctrlGroup controlsGroupCtrl IDC_INGRESS_SLIDER_EDIT;
private _ctrlToggle = _ctrlGroup controlsGroupCtrl IDC_INGRESS_TOGGLE;
