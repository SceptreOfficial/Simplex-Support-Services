...
[CTRL(IDC_RANGE),CTRL(IDC_RANGE_EDIT),[600,[3500,2500] select _isHelicopter,0],"range",[2600,1000] select _isHelicopter,LELSTRING(common,meterAcronym)] call FUNC(gui_slider);
